...
def create_combined_video(base_path, output_path, num_videos=10, num_phases=17, tissue_idx=1, relative_kinematics_flag=False, kinematics_vis_step_size=10,
                          after_phase_offset = 0, before_phase_offset = 0, desired_camera_names=["endo_psm2", "left_img_dir", "endo_psm1"], phase_text_flag=True, save_each_n_frame_as_image_wo_text=30):
   ...
   # Create the parent directory if it does not exist
    ...
    for vid_index in range(num_videos):
        ...
        for phase_idx in range(1, num_phases + 1):
            ...
            # TODO: Later make kinematics relative to the first frame of the episode
            
            # TODO: Also possible to add the orientation of the tool (e.g., jaw angle) to the visualization
            ...
            for frame_idx in range(start, end + 1):
                ...
                # TODO: Add also the kinematics canvas
...
if __name__ == "__main__":
    ...
    desired_camera_names = ["endo_psm2", "left_img_dir", "endo_psm1"] 
    ...
    # Generate the combined kinematics video
    # create_combined_video_with_kinematics(...)
