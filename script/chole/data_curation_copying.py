...
if __name__ == "__main__":
    ...
    dataset_name = "base_chole_clipping_cutting_amos" # "base_chole_clipping_cutting" "base_chole_clipping_cutting_amos" "phantom_chole" 
    dataset_folder = os.path.join(os.getenv("PATH_TO_DATASET"), dataset_name)
    target_filename = "indices_curated.json"
    output_folder = os.path.join(os.getenv("PATH_TO_DATASET"), "curated_indices_data_amos")
