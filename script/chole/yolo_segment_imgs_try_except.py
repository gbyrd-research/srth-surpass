...
yolo_model_path = os.path.join(model_ckpts_folder, "yolo", "best.pt") # "/home/imerse/yolo/runs/segment/train8/weights/best.pt"
    ...
    for dir in dirlist:
        ...
        for item in os.listdir(phase):
            try:
                ...
                print(f"Error processing {phase}/{item}: {e}")
                failed_folders.append(phase + "/" + item)
                time.sleep(2)
                continue
